<template>
    <div>
        ...
        <div class="row rounded">
            ...
            <div class="col-md-6 flex justify-content-between align-items-center">
                ...
                <div class="ms-4 w-100">
                    ...
                    <div class="my-2">
                        <input type="text" :value="user.name" placeholder="Name . . ." class="form-control">
                    </div>

                    <div class="my-2">
                        <input type="text" :value='user.country' placeholder="country . . ." class="form-control">
                    </div>

                    <div class="my-2">
                        <input type="text" :value="user.bio" placeholder="Bio . . ." class="form-control">
                    </div>
        ...
        <div class="my-3">
            ...
            <input type="text" :value="user.message" placeholder="UR Message . . ." class="form-control">
